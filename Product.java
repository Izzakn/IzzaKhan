...
public class Product
{
    ...
    public Product getrecentMonth(Product p1, Product p2)
    {
        Date latest = datemanufacture.recentMonth(p1.datemanufacture,p2.datemanufacture);
        if (latest == p1.datemanufacture)
            return p1;
        else
            return p2;
    }
